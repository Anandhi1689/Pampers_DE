...
public static String LoginXpath = System.getProperty("user.dir") + "//src//test//java//com//aymcommerce//pg//clubpampers//log//locators//Login.properties";
	...
	public static By getElementBy(String ID,String locatorfile) throws Throwable  {
	...
	public static void sendKeystoElement1(String LoadXpath, String Data, String locatorfile) throws Throwable {
		Properties Prop = new Properties();
		File Location = new File(locatorfile);
		FileReader File = new FileReader(Location);
		Prop.load(File);
	...
	public static String getElementvalue(String LoadXpath, String locatorfile) throws Throwable {
		...
		Prop.load(File);
		String Xpath = Prop.getProperty(LoadXpath);
		Wait wait2 = new FluentWait(driver).withTimeout(30, TimeUnit.SECONDS).pollingEvery(250, TimeUnit.MILLISECONDS)
				.ignoring(NoSuchElementException.class).ignoring(TimeoutException.class);
		wait2.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(Xpath)));
		WebElement elem = driver.findElement(By.xpath(Xpath));
		Thread.sleep(2000);
	...
	public String mail(String pass) throws Throwable
	{
        ...
        driver.navigate().refresh();
        Thread.sleep(6000);
        List resetmail = driver.findElements(By.xpath("//*[@text='noreply@janrain.com']"));
       ...
       // System.out.println(tableText);
        ...
        firstElement.click();
        Thread.sleep(5000);
        WebElement passwordlink = driver.findElementByXPath("(//*[contains(text(),'Passwort')])[3]");
        passwordlink.click();
        Thread.sleep(5000);
        clickElement("passwordfield", LoginXpath);
        sendKeystoElement1("passwordfield", pass, LoginXpath);
        Thread.sleep(5000);
        driver.hideKeyboard();
